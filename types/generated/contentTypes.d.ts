...
export interface ApiExitRequestExitRequest extends Struct.CollectionTypeSchema {
  collectionName: 'exit_requests';
  info: {
    displayName: 'Exit Request';
    pluralName: 'exit-requests';
    singularName: 'exit-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exitRequestId: Schema.Attribute.UID & Schema.Attribute.Required;
...
export interface ApiLateEntryRequestLateEntryRequest
  extends Struct.CollectionTypeSchema {
...
export interface ApiQrTokenQrToken extends Struct.CollectionTypeSchema {
  collectionName: 'qr_tokens';
  info: {
    displayName: 'qr-token';
    pluralName: 'qr-tokens';
  ...
  attributes: {
    ...
    consumed_by: Schema.Attribute.Enumeration<['gate', 'system']>;
    consumedAt: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exit_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::exit-request.exit-request'
    >;
...
export interface ApiScanLogScanLog extends Struct.CollectionTypeSchema {
  collectionName: 'scan_logs';
  info: {
    displayName: 'scan-log';
    pluralName: 'scan-logs';
    singularName: 'scan-log';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exit_request: Schema.Attribute.Relation<
      'oneToOne',
      'api::exit-request.exit-request'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reason: Schema.Attribute.Text;
    result: Schema.Attribute.Enumeration<['verified', 'rejected']>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::exit-request.exit-request': ApiExitRequestExitRequest;
      'api::late-entry-request.late-entry-request': ApiLateEntryRequestLateEntryRequest;
      'api::qr-token.qr-token': ApiQrTokenQrToken;
      'api::scan-log.scan-log': ApiScanLogScanLog;
